...
const Footer = () => {
  ...
  return (
    <footer className=" text-center text-sm text-surface/75  lg:text-left pb-5">
      <div className="Block">
        <div className="flex justify-between  flex-col-reverse  md:flex-row">
          <p>
            <span className="copy-right">
              © HaidarCodes LTD, {year}. Ain't no stoppin' me. Copywritten, so
          ...
          <ul className="  social-links flex justify-center items-center ">
            <li className="mt-5  mb-5 md:mt-0 md:mb-0">
              <a aria-label="github" href="https://github.com/HaiderAziz428">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="transition duration-300 ease-in-out hover:fill-yellow-300"
                  >
            ...
            <li className="mt-5  mb-5 md:mt-0 md:mb-0">
              <a
                ...
                href="https://www.instagram.com/haider_aziz428/"
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
