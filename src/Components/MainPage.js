...
const MainPage = () => {
  return (
    <main>
      ...
      <p>
        <span className="mt-12 mb-2 text-2xl">💛</span>
        I’m @haidar.codes, <b>“Haidar”</b> for short! I’m a full-stack web
        ...
        <ul className="grid gap-4">
          <li>
            <a
              ...
              href="https://blockchain-based-land-record-system.vercel.app/"
            >
              <h3 className="flex items-center space-x-2 group underline decoration-gray-700 underline-offset-4 hover:text-yellow-300 transition-colors duration-300">
                <span>Blockchain Land Record System</span>
                <svg
                  className="w-5 h-5"
                  viewBox="0 -0.5 25 25"
                  fill="currentColor"
              ...
              {
                "is a full-stack Web3 application for secure, transparent land registration powered by Solidity smart contracts, Next.js, RainbowKit wallet auth, and Supabase."
              }
            </a>
          </li>
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.assemblylineworkshop.com"
            >
              <h3 className="flex items-center space-x-2 group underline decoration-gray-700 underline-offset-4 hover:text-yellow-300 transition-colors duration-300">
                <span>AssemblyLine</span>
                <svg
                  className="w-5 h-5"
                  viewBox="0 -0.5 25 25"
                  fill="currentColor"
              ...
              {
                "is a premium auto repair shop web app built with Next.js 15 and TypeScript, featuring a smart booking system with real-time Discord webhook notifications and Zod form validation."
              }
            </a>
          </li>
          <li>
            ...
            >
              ...
              {
                "is a decentralized banking system powered by blockchain technology that lets users securely deposit, withdraw, and earn compound interest on-chain."
              }
            </a>
          </li>
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://crypto-pulse-amber.vercel.app/"
            >
              <h3 className="flex items-center space-x-2 group underline decoration-gray-700 underline-offset-4 hover:text-yellow-300 transition-colors duration-300">
              ...
              {
                "is a real-time cryptocurrency dashboard built with Node.js and Express that tracks the top 20 coins with live prices, market caps, and 24h changes via the CoinPaprika API."
              }
            </a>
          </li>
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/HaiderAziz428/Car-Damage-Detection-and-Classification"
            >
              <h3 className="flex items-center space-x-2 group underline decoration-gray-700 underline-offset-4 hover:text-yellow-300 transition-colors duration-300">
                <span>Car Damage Detection</span>
                <svg
                  className="w-5 h-5"
                  viewBox="0 -0.5 25 25"
                  fill="currentColor"
              ...
              {
                "is an AI-powered app that lets users upload car photos and receive automated damage severity reports, built with a React + Vite frontend and a Python computer vision backend."
              }
            </a>
          </li>
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/HaiderAziz428"
            >
              <h3 className="flex items-center space-x-2 group underline decoration-gray-700 underline-offset-4 hover:text-yellow-300 transition-colors duration-300">
      ...
      <p>
        ...
        — integrating design thinking into every line of code.
        <br />
        <br />
      ...
      <span className="mt-12 mb-5 text-4xl">✨</span>
      <p>
